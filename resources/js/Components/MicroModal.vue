...
<template>
  ...
  <div class="flex">
    <input name="customer" v-model="search" class="w-3/4 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1  leading-8 transition-colors duration-200 ease-in-out">
    <button @click="searchCustomers" type="button" data-micromodal-trigger="modal-1" class="mx-auto text-white bg-teal-500 border-0 py-2 px-4 focus:outline-none hover:bg-teal-600 rounded text-lg">検索する</button>
  </div>
</template>
