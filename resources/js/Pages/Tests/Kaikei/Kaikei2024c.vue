    ...
    <section class="bg-gray-100 text-gray-800 py-10">
        ...
        <div class="max-w-4xl mx-auto mt-4 space-y-2">
            ...
            <QuestionTemp1
                ...
                '正しい',
                '（借方）費用の発生：（貸方）<b><u>資産の減少</u></b><br>従業員に、給料200,000円を支払った。<br>（借方）給料 200,000（貸方）現金 200,000<br><br>（借方）<b><u>資産の増加</u></b>：（貸方）収益の発生<br>貸付金の利息40,000円が振込まれた。<br>（借方）預金 40,000（貸方）受取利息 40,000', //p12
                ]"
                />
            <QuestionTemp1
                :questionNumber="22"
            ...
            <QuestionTemp1
                ...
                '危険準備金は、法人税法上は利益性の内部留保との立場から、損金とはならない。' //p41
                ]"
            />
            <QuestionTemp1
                :questionNumber="25"
            ...
            <QuestionTemp2
                ...
                '正しい',
                '金融商品取引法上、流通市場における開示書類には、「有価証券報告書」、「半期報告書」、「四半期報告書」および「臨時報告書」等がある。', //p30
                '10%以上ではなく、20%以上。', //p41
                '正しい',
                // 問36〜40
                '正しい',
                '据置期間に対応する利息も「保険金据置支払金」に計上される。', //p158
                '生命保険会社が支払う税金のうち、法人税やそれを基礎として計算される都道府県民税・市町村民税については、原則として当期に生じた剰余金から支払われるべきものであるから、損益計算書上、他の税金と区別して税引前当期剰余から控除する形式で表示される。', //p164
                '正しい',
                '正しい',
                 //問41〜50
                'B-買掛金元帳','C（A・Bともに正しい）','A-負債','B-純保険料','B-保険業法',
                'B-定額法','A-実現主義','A-損益計算書','C（A・Bともに正しい）','A-税務調査',
                ]"
                :labels="[
                '解','解','解','解','解',  //問31〜35
                '解','解','解','解','解',  //問36〜40
