    ...
    <section class="bg-gray-100 text-gray-800 py-10">
        ...
        <div class="max-w-4xl mx-auto mt-4 space-y-2">
            <QuestionTemp4
                ...
                :contents="[
                    ...
                    },
                    {
                        ...
                        現在において必要な資金の合計は、<strong>1,956,950円</strong>'
                    }
                ]"
                :labels="[
                    'カ','キ','ウ','エ','コ',  //問１〜５
            ...
            <QuestionTemp3
                ...
                :subject="subject"
                :contents="[
                '0.98130','97,957','1.02','1,337,330','13,710', //問６〜10
                ]"
                :labels="[
                'イ','ク','ウ','コ','カ',  //問６〜10
                ]"
            ...
            <QuestionTemp4
                ...
                :contents="[
                    // 問21
                    {
                        ...
                        50歳：3,000,000 × 192 × 0.995037 ＝ 573,141,312<br>\
                        51歳：3,000,000 × 205 × 0.985185 ＝ 605,888,775<br>\
                        52歳：3,000,000 × 219 × 0.975431 ＝ 640,858,167<br>\
                        53歳：3,000,000 × 234 × 0.965773 ＝ 677,972,646<br>\
                        54歳：3,000,000 × 248 × 0.956211 ＝ 711,420,984<br>\
                        合計は3,209,281,884円<br>\
                        ⇒ 千円未満を四捨五入して <strong>3,209,282千円</strong>'
                    },
                    // 問22
                    {
                        ...
                        96,441 × 3,000,000 × 0.951466 ＝ 275,280,997,518円<br>\
                        ⇒ 千円未満を四捨五入して <strong>275,280,998千円</strong>'
                    },
                    // 問23
                    {
                        answer: '7,315,425千円',
                        ...
                        3,000,000 × (25 ÷ 1000) × 97,539 ＝ 7,315,425,000<br>\
                        ⇒ 千円未満を四捨五入して <strong>7,315,425千円</strong>'
                    },
                    // 問24
                    {
                        answer: '600,260円',
                        ...
                        → 50歳～54歳の収入現価の合計 ＝ 476,137P<br>\
                        ※小数第1位を四捨五入 <br><br>\
                        ＜支出現価＞<br>\
                        支出現価は問21〜23で算出した結果を用いて求める。<br><br>\
                        死亡保険金の現価+満期保険金の現価+予定事業費の現価<br>\
                        ＝ 3,209,282千円 + 275,280,998千円 + 7,315,425千円<br>\
                        ＝ 285,805,705千円<br><br>\
                        収支相当の原則より<br>\
                        476,137P = 285,805,705千円<br>\
                        P ＝ 600,259･･･円 <br>\
                        ⇒ 10円未満を四捨五入して <strong>600,260円</strong>'
                    },
                    // 問25
                    {
                        answer: '1,097,000円',
                        ...
                        ＝ 858,000 × (3,000,000 ÷ 2,345,580)<br>\
                        ＝ 1,097,383･･･円<br>\
                        ⇒ 千円未満を四捨五入して <strong>1,097,000円</strong>'
                    }
                ]"
                :labels="[
                    'ア','イ','ウ','イ','ア',  //問21〜25
            ...
            <QuestionTemp2
                ...
                '正しい',
                 //問41〜50
                'C（A・Bともに正しい）', 'B-総合表', 'B-1年間の毎日の資産残高の累計', 'A-高くなる', 'B-危険保険金',
                'A-契約者貸付', 'A-保険年度末保険料積立金', 'A-責任準備金', 'C（A・Bともに正しい）', 'B-純保険料率',
                ]"
                :labels="[
                '解','解','解','解','解',  //問31〜35
                '解','解','解','解','解',  //問36〜40
