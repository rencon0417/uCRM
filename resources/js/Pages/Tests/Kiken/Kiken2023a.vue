    ...
    <section class="bg-gray-100 text-gray-800 py-10">
        ...
        <div class="max-w-4xl mx-auto mt-4 space-y-2">
            ...
            <QuestionTemp1
                ...
                :subject="subject"
                :contents="[
                '若年層には先天性のものが多く、中年および高年齢になると高血圧性、虚血性が多くなる。',
                '正しい',
                '二次性高血圧と本態性高血圧の説明が逆。'
                ]"
            />
            <QuestionTemp1
                ...
                :subject="subject"
                :contents="[
                '逆選択は健康に自信のない者が保険に加入したがる心理的な傾向で、道徳的危険の一つである。しかし、このような人題の心理的状態を危険の要素として直接測定することはできはできない。',
                '正しい',
                '保険業法ではなく保険法。'
                ]"
            />
            ...
            <QuestionTemp2
                ...
                '正しい',
                 //問41〜50
                'B-金額死亡率', 'C（A・Bともに正しい）', 'B-収支相当の原則', 'A-加入申込者群', 'A-入院率',
                'A-告知書', 'B-再診', 'B-不実の告知', 'C（A・Bともに正しい）', 'A-1年間',
                ]"
                :labels="[
                '解','解','解','解','解',  //問31〜35
                '解','解','解','解','解',  //問36〜40
