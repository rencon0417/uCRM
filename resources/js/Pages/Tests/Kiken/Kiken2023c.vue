    ...
    <section class="bg-gray-100 text-gray-800 py-10">
        ...
        <div class="max-w-4xl mx-auto mt-4 space-y-2">
            <QuestionTemp3
                ...
                :subject="subject"
                :contents="[
                '死亡率','心理的','大数の法則','募集担当者','第1次選択', // 問１〜５
                ]"
                :labels="[
                'オ','ウ','カ','ケ','キ',  //問１〜５
                ]"
            ...
            <QuestionTemp1
                ...
                :contents="[
                '正しい',
                '明確な債権債務関係が存在するものとは限らず、道徳的危険が潜在するおそれがある。',
                '推奨されておらず、保険本来の趣旨に逸脱したものとされている。'
                ]"
            />
            <QuestionTemp1
                :questionNumber="24"
                ...
                :subject="subject"
                :contents="[
                '契約確認は一部の契約については契約成立前に行い、大部分は契約成立後に行うのが実情である。',
                '正しい',
                '保険金受取人ではなく被保険者や契約者。'
                ]"
            />
            ...
            <QuestionTemp1
                ...
                '正しい',
                '正しい',
                '若年層の死亡指数を引き下げることは、高齢層の死亡指数を引き下げるより困難である。'
                ]"
            />
            <QuestionTemp1
                :questionNumber="27"
            ...
            <QuestionTemp2
                ...
                '正しい',
                 //問41〜50
                'A-選択表', 'C（A・Bともに正しい）', 'B-危険保険料', 'C（A・Bともに正しい）', 'A-生命保険協会',
                'A-告知書', 'B-特別保険料領収法', 'B-不実の告知', 'A-き損', 'B-両眼の視力',
                ]"
                :labels="[
                '解','解','解','解','解',  //問31〜35
                '解','解','解','解','解',  //問36〜40
