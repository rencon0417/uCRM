    ...
    <section class="bg-gray-100 text-gray-800 py-10">
        ...
        <div class="max-w-4xl mx-auto mt-4 space-y-2">
            ...
            <QuestionTemp1
                ...
                '正しい',
                '死亡指数は「実際死亡率÷予定死亡率×100（%)」で計算される。' //p11
                ]"
            />
            <QuestionTemp1
                :questionNumber="23"
                ...
                '<u><b>二次性高血圧</b></u>とは、高血圧の原因となっている疾病が<u><b>はっきりしている</b></u>ものをいい、<u><b>本態性高血圧</b></u>とは、原因が<u><b>明らかでない</b></u>ものをいう。' //p64-65
                ]"
            />
            <QuestionTemp1
                :questionNumber="24"
            ...
            <QuestionTemp1
                ...
                '正しい',
                '失効後の期間の長いものほど逆選択混入の危険が多く、また<u><b>診査による場合に比べ告知のみによる場合のほう</b></u>が経験死亡率が高いとされている。' //p173-174
                ]"
            />
            <QuestionTemp1
                :questionNumber="26"
                ...
                '正しい',
                '正しい',
                '告知の時期について、約款には「保険契約締結の際、書面で告知を求めた時」としているが、<u><b>書面による告知をした時以降に生じた事項については、告知義務はないとしている</b></u>。' //p16
                ]"
            />
            <QuestionTemp1
                :questionNumber="27"
            ...
            <QuestionTemp2
                ...
                '死差益の計算方法として、ボールマンにより考案された純収支計算方式と統計的方式の両式がある。<u><b>統計的方式</b></u>で表せば、基本的には死差益は年間の危険保険料収入額と危険保険金支払額との差として表される。', //p27
                '正しい',
                'BMIは「体重(kg) ÷ [身長(m)]<sup>2</sup>」で表される指数で標準値を22前後としている。', //p63
                // 問36〜40
                '正しい',
                '保険金確認・給付金確認を行う時期が死亡その他の保険事故発生後であるため、確認の対象は保険事故発生前の契約確認と若千異なっている。しかし、告知義務違反やモラルリスクを排除し、生命保険の公平性の原則を達成しようとする目的自体は契約確認となんら変わるところはない。', //p119-120
                '正しい',
                '正しい',
                '正しい',
                 //問41〜50
                'B-質問応答義務', 'A-純保険料', 'A-倫理', 'A-入院率', 'B-被保険利益',
                'B-医師による診査', 'C（A・Bともに正しい）', 'A-き損', 'B-両眼の視力', 'C（A・Bともに正しい）',
                ]"
                :labels="[
                '解','解','解','解','解',  //問31〜35
                '解','解','解','解','解',  //問36〜40
