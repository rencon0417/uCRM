    ...
    <section class="bg-gray-100 text-gray-800 py-10">
        ...
        <div class="max-w-4xl mx-auto mt-4 space-y-2">
            ...
            <QuestionTemp2
                ...
                '正しい',
                '正しい',
                '死亡保険契約の保険者は、保険金受取人が被保険者を故意に死亡させたとき保険給付を行う責任を負わない。ただし、被保険者を故意に死亡させた保険金受取人以外の保険金受取人に対する責任については、この限りでない。', //p60
                ...
                '生命保険会社の名称変更のみを行う場合も金融庁長官の認可は必要である。', //p222
                '金融庁長官ではなく、内閣総理大臣。', //p201
                '正しい',
                 //問41〜50
                'A-民法','B-2024年（令和6年）12月31日','C（A・Bともに正しい）','C（A・Bともに正しい）','A-解除の原因を知った時',
                'B-感染症','C（A・Bともに正しい）','A-保険契約者保護機構','A-毎決算期','B-媒介',
                ]"
                :labels="[
                '解','解','解','解','解',  //問31〜35
                '解','解','解','解','解',  //問36〜40
